  ...
  >
    <div class="sidenav-header">
      ...
      <a
        ...
        target="_blank"
      >
        <span class="font-weight-bold text-lg">B.O.B Tennis Club</span>
      </a>
    </div>
    <div
    ...
    >
      <ul class="navbar-nav">
        <li class="nav-item" @click="push('Tổng quan')">
          <router-link
            to="/dashboard"
            active-class="active"
            class="nav-link"
        ...
        <li class="nav-item" @click="push('Quỹ hội')">
          <router-link to="/fund" active-class="active" class="nav-link">
            <div
              class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center"
            >
              <svg
        ...
        <li class="nav-item border-start my-0 pt-2" @click="push('Hồ sơ')">
          <router-link
            :to="`/profile/${this.$store.state.userLocal.member_id}`"
            active-class="active"
            class="nav-link"
          >
